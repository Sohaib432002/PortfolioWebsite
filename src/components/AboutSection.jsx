...
const AboutSection = () => {
    ...
    About
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <motion.div
            ...
            className="w-60 h-60 rounded-2xl shadow-xl border-2 border-cyan-400 overflow-hidden bg-white/10 backdrop-blur-md"
          >
            <img
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed text-lg">
              ...
              from <span className="text-cyan-400 font-semibold">Mianwali, Pakistan</span>.
  ...
  { icon: <FaCloud />, label: "Deployment" },
              ...
              <motion.div
                ...
                key={idx}
                className="flex flex-col items-center gap-2 p-4 bg-white/5 rounded-xl border border-white/10 shadow-lg backdrop-blur-md"
              >
