  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-b from-[#0a0f2a] to-[#041028] text-white py-12 sm:py-20 px-4 sm:px-6 md:px-10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <h2 className="text-3xl my-10 sm:text-4xl pointer-events-none md:text-5xl font-extrabold text-center mb-6 sm:mb-12">
          <span className=" bg-gradient-to-r from-cyan-400 to-blue-600 bg-clip-text text-transparent drop-shadow-md">
            Services
          </span>{' '}
          / What I Offer
        </h2>
        <div className="text-sm pointer-events-none sm:text-base md:text-xl text-gray-300 font-medium text-center mb-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <p className="text-gray-300 text-sm pointer-events-none sm:text-base md:text-base">
                {service.description}
              </p>
            </motion.div>
          ))}
