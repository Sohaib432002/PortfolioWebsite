const AchievementsAndCertificates = () => {
  return (
    <section className="w-full py-16 px-4 sm:px-6 md:px-10 bg-gradient-to-b from-[#0a0f1f] via-[#101c3a] to-[#0a0f1f] text-white">
      <h2 className="text-center my-10 pointer-events-none text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 sm:mb-10 tracking-tight">
      ...
      <p className="text-center text-sm pointer-events-none sm:text-base md:text-lg text-gray-300 max-w-2xl mx-auto mb-12 sm:mb-16">
        A complete showcase of my achievements, recognitions, certifications, internships, and
        milestones throughout my academic and professional journey.
      </p>
      ...
      <div className="max-w-6xl mx-auto space-y-12 sm:space-y-16">
        {[
          ...
          >
            ...
            />
            <div className="flex-1 pointer-events-none text-center sm:text-left">
              <h4 className="text-xl sm:text-2xl md:text-3xl font-bold text-cyan-400 mb-2 sm:mb-4">
                {cert.title}
              </h4>
              <p className="text-gray-300 text-sm sm:text-base mb-2 sm:mb-4 leading-relaxed">
                {cert.desc}
              </p>
